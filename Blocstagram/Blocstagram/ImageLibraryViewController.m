...
@property (nonatomic, strong) PHFetchResult *result;//a PHFetchResult. It acts like a high performance array of image assets. Unlike an array, it doesn't store the images in memory at once, but rather "fetches objects from the backing store in chunks on demand".
