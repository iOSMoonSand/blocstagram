...
//will post the method to Instagram's comments endpoint. If it succeeds, it'll refetch the media item with the new comment. If not, it simply reloads the row
